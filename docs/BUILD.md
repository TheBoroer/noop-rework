...
(`NOOP-full.apk`) is published in [Releases](https://github.com/ryanbr/noop/releases). The former
sample-data **demo** flavour has been removed; the app builds as a single `com.noop.whoop.rework` APK.
