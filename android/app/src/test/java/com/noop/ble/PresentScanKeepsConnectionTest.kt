 ...
 * ([AndroidWhoopBleClient.shouldKeepLiveConnectionForPresentScan], driven by prepareForPresentScan) - the
 ...
 * [AndroidWhoopModel] has exactly two members (one per family), so enum equality IS the family check.
 */
class PresentScanKeepsConnectionTest {

    @Test
    fun connectedSameModel_keepsTheLiveConnection() {
        assertTrue(AndroidWhoopBleClient.shouldKeepLiveConnectionForPresentScan(
            connected = true, selected = AndroidWhoopModel.WHOOP5_MG, requested = AndroidWhoopModel.WHOOP5_MG))
        assertTrue(AndroidWhoopBleClient.shouldKeepLiveConnectionForPresentScan(
            connected = true, selected = AndroidWhoopModel.WHOOP4, requested = AndroidWhoopModel.WHOOP4))
    }
    ...
    fun connectedOtherModel_idlesForTheFamilySwitch() {
        ...
        assertFalse(AndroidWhoopBleClient.shouldKeepLiveConnectionForPresentScan(
            connected = true, selected = AndroidWhoopModel.WHOOP4, requested = AndroidWhoopModel.WHOOP5_MG))
        assertFalse(AndroidWhoopBleClient.shouldKeepLiveConnectionForPresentScan(
            connected = true, selected = AndroidWhoopModel.WHOOP5_MG, requested = AndroidWhoopModel.WHOOP4))
    }
    ...
    fun disconnectedSameModel_idles() {
        ...
        assertFalse(AndroidWhoopBleClient.shouldKeepLiveConnectionForPresentScan(
            connected = false, selected = AndroidWhoopModel.WHOOP5_MG, requested = AndroidWhoopModel.WHOOP5_MG))
    }

    @Test
    fun disconnectedOtherModel_idles() {
        assertFalse(AndroidWhoopBleClient.shouldKeepLiveConnectionForPresentScan(
            connected = false, selected = AndroidWhoopModel.WHOOP4, requested = AndroidWhoopModel.WHOOP5_MG))
    }
}
