...
object BatteryAlertNotifier {
    ...
    private const val NOTIF_ID_RUNTIME = 4205   // #297/#304 discipline: every notifier id distinct

    /**
     * #250: predictive twin of [onBatteryUpdate]: run the runtime estimate against
     ...
     * off. Upstream twin: BatteryNotifier.onRuntimeEstimate (4a91bb2c).
     */
