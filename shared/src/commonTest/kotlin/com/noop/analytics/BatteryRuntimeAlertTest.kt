...
/**
 * #250: behaviour-identical twin of upstream's BatteryRuntimeAlertTest(s) (4a91bb2c) — same
 * fixtures, same numbers. Lives in commonTest (the policy is in shared BatteryEstimator), so the
 * JVM and iosSimulatorArm64 runs both pin it.
 */
class BatteryRuntimeAlertTest {
    ...
    fun jitterInsideBandCannotRefire() {
        ...
        for (hours in listOf(26.0, 22.0, 30.0, 24.0)) {
            ...
            assertFalse(r.fire, "re-fired at ${hours}h inside the hysteresis band")
