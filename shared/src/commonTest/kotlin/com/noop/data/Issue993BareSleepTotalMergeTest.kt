...
class Issue993BareSleepTotalMergeTest {
    ...
    fun bareSleepAggregate_matchesHcBackfillShapeOnly() {
        ...
        kotlin.test.assertTrue(WhoopRepository.bareSleepAggregate(hcBackfillRow("2026-06-28")))
        kotlin.test.assertFalse(WhoopRepository.bareSleepAggregate(scoredNight("2026-06-28")))
