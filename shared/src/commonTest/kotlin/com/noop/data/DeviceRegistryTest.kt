...
class DeviceRegistryTest {
    ...
    private class FakeRegistryDao : DeviceRegistryDao {
        ...
        override suspend fun deleteDayOwnershipFor(deviceId: String) {
            ...
            owners.entries.removeAll { it.value.deviceId == deviceId }
        }
    }
    ...
    @Test
    fun seededWhoopIsActive() = runTest {
    ...
    @Test
    fun setActiveDemotesPreviousAndKeepsExactlyOneActive() = runTest {
        val dao = seededDao()
    ...
    @Test
    fun archiveKeepsRowAndClearsActive() = runTest {
        val reg = registryWith(seededDao())
    ...
    @Test
    fun renameSetsAndClearsNickname() = runTest {
        val reg = registryWith(seededDao())
    ...
    @Test
    fun deleteDeviceDataKeepsRegistryRowAndClearsOwnership() = runTest {
        val reg = registryWith(seededDao())
    ...
    @Test
    fun deleteDeviceDataForAppleHealthFansOutToEveryDeviceScopedTableAndKeepsRegistry() = runTest {
    ...
    @Test
    fun seededWhoopHasNoPeripheralIdUntilSet() = runTest {
    ...
    @Test
    fun setPeripheralIdRoundTrips() = runTest {
        val reg = registryWith(seededDao())
    ...
    @Test
    fun dayOwnerUpsertAndRead() = runTest {
        val reg = registryWith(seededDao())
