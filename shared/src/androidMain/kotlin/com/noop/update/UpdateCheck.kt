...
object UpdateCheck {
    ...
    /**
     * True iff [latest] is a strictly newer version than [current]. Delegates to the pure,
     * commonMain [VersionCompare.isNewer] (dot-separated numeric segment comparison, tolerant of
     * a leading "v" and any non-numeric suffix).
     */
    fun isNewer(latest: String, current: String): Boolean = VersionCompare.isNewer(latest, current)
