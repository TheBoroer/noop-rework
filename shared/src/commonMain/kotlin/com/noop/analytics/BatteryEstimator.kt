...
object BatteryEstimator {
    ...
    // ---- Predictive low-battery alert policy (#250, upstream 4a91bb2c) ----
     ...
     * twin of the upstream Swift/Kotlin `BatteryEstimator.runtimeAlert` (same fixtures, same numbers).
     *
     ...
     * every ~8 min, and a strap that never reports one should still warn. A suppressed-while-charging
     * evaluation does NOT consume the once-per-discharge gate.
     */
