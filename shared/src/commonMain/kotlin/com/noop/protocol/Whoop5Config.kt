...
object Whoop5Config {
     ...
     *  byte-for-byte in this order. `enable_sig12`'s value was corrected 0x32→0x31 (#423/#522): a second
     *  real on-strap capture, this time spanning a live workout, reproduced flags 1–15 identically but
     *  decoded enable_sig12 as ASCII '1'. Keep in lockstep with the Swift `Whoop5Config.enableR22Sequence`. */
    val enableR22Sequence: List<Flag> = listOf(
        ...
        Flag("enable_sig12", 0x31),   // #103: 16th flag seen in a real on-strap capture, not in judes.club; value 0x32→0x31 (#423/#522)
    )
